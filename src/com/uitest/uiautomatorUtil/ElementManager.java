...
public class ElementManager {
	 ...
	 */
	public static UiObject getUiObjectByIdClass(String id, String destClass, int num) throws UiObjectNotFoundException{
	 ...
	 * @throws UiObjectNotFoundException
	 */
	public static UiObject getUiObjectByIdId(String rootid, String id, int num) throws UiObjectNotFoundException{
	 ...
	 * @throws UiObjectNotFoundException
	 */
	public static UiObject getUiObjectByClassClass(String rootClass, String destClass, int num) throws UiObjectNotFoundException{
		return getSameClassObjectMatches("class", rootClass, "class", destClass, num);
	}
	 ...
	 * @throws UiObjectNotFoundException
	 */
	public static UiObject getUiObjectByClassId(String rootClass, String id, int num) throws UiObjectNotFoundException{
	 ...
	 * @throws UiObjectNotFoundException
	 */
	public static UiObject getSameClassObject(String type1, String root, String type2, String sub, int num) 
			throws UiObjectNotFoundException {
	 ...
	 * @throws UiObjectNotFoundException
	 */
	public static UiObject getSameClassObjectMatches(String type1, String root, String type2, String sub, int num) 
			throws UiObjectNotFoundException {
		...
		if(type1.equals("class"))
		{
			collection = new UiCollection(new UiSelector().classNameMatches(".*"+root));
		}
		else if(type1.equals("id"))
		{
			collection = new UiCollection(new UiSelector().resourceIdMatches(".*"+root));
		}
		else if(type1.equals("text"))
		{
		...
		if(type2.equals("class"))
		{
			CheckObject = collection.getChildByInstance(new UiSelector().classNameMatches(".*"+sub), num);
		}
		else if(type2.equals("id"))
		{
			CheckObject = collection.getChildByInstance(new UiSelector().resourceIdMatches(".*"+sub), num);
		}
		else if(type2.equals("text"))
		{
			CheckObject = collection.getChildByInstance(new UiSelector().textContains(sub), num);
		}
		return CheckObject;
	}
	 ...
	 * @param name
	 */
	public static UiObject getUiObjectSearchByClassNameAndName(String className,String name) {
	...
	public static UiObject getSameLineObjectById(UiObject srcObject, String id,
		...
		try {
			...
			int y1 = r1.bottom + dowmOffset;
			for (int i = 0; i < 10; i++) {
				CheckObject = collection.getChildByInstance(new UiSelector().resourceId(id)
						, i);
				Rect rect = CheckObject.getBounds();
				int centy = rect.centerY();
				if (centy > y0 && centy < y1) {
	...
	public static int getChildCountByClassId(String rootClass, String id){
		UiCollection collection=new UiCollection(new UiSelector().classNameMatches(".*"+rootClass));
	 ...
	 * @return
	 */
	public static int getChildCountByClassClass(String rootClass, String subClass){
		UiCollection collection=new UiCollection(new UiSelector().classNameMatches(".*"+rootClass));
		int cnt=collection.getChildCount(new UiSelector().classNameMatches(".*"+subClass));
		return cnt;
	}
	 ...
	 * @return
	 */
	public static UiObject getUiObjectScrollListViewByText(String classname, String text){
		UiScrollable scroll=new UiScrollable(new UiSelector().classNameMatches(".*"+classname));
	...
	private static void myLongClick(UiObject uo, int step){
		...
		try {
			...
			//滑动同一点
			UiDevice.getInstance().swipe(buttonRect.centerX(), buttonRect.centerY(),  
					buttonRect.centerX(), buttonRect.centerY(), step);
		} catch (UiObjectNotFoundException e) {
	...
	/**
	 * 同类控件，根据num，获取按顺序的对象
	 * @param srcObject 父类classname
	 * @param destClass 控件id
	 * @param num 第几个，从0开始
	 * @return
	 */
	public static void clickSameClassObjectByOne(String rootClass, String id, int num) {
		try {
	 ...
	 * @return
	 */
	public static void clickSameClassObject(String type1, String rootClass,String styp2, String destClass, int num) {
		try {
